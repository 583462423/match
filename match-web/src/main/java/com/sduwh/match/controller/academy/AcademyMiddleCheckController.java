...
public class AcademyMiddleCheckController extends BaseController {
    private static final Logger logger = LoggerFactory.getLogger(AcademyMiddleCheckController.class);
    private static final String ACADEMY_MIDDLE_CHECK = "/academy/middle_check_items";
    private static final String ACADEMY_MIDDLE_CHECK_ALTER = "/academy/middle_check_alter";
    ...
    public String getMiddleCheck(@PathVariable("id") int matchItemId,
        ...
        return ACADEMY_MIDDLE_CHECK_ALTER;
    }
    ...
    public String updateTeacherReport(MiddleCheck middleCheck){
        ...
        if(tmp.getStage() != MiddleCheckStage.ACADEMY_JUDGE.getCode()){
    ...
    public String submit(@RequestParam("matchItemId") int matchItemId){
        ...
        jedisAdapter.sadd(RedisKeyGenerator.getTeacherMiddleCheckKey(superUser.getId()),String.valueOf(matchItemId));
        return setJsonResult("success","true");
    }
