    ...
    <div style="width: 100%;height: 100%;">
        <form action="/academy/match/concluding/report/update" method="post" id="updateForm">
            ...
            <div class="input-group">
                ...
                <textarea style="height: 150px;" name="viewOfAcademy" placeholder="请输入学院评价" class="form-control">${concludingStatement.viewOfAcademy}</textarea>
            </div>
                ...
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        if(json["success"] == "true"){
                            ...
                            setTimeout("location.href='/academy/match/concluding'",2000);
                        }else{
                            showMsg(json["error"]);
                        }
                    }
