...
<mydiv>
            ...
            <table class="table table-bordered">
                ...
                <c:forEach items="${logs}" var="item">
                    <tr>
                        ...
                        <td><c:out value="${fn:substring(item.time, 0, 10)}" />&nbsp;&nbsp;${item.startTime}时 ～ ${item.endTime}时</td>
                        <td>${item.title}</td>
                        <td>
                            <span class="label label-info itemDetail" data="${item.id}" style="cursor: pointer;"><i class="glyphicon glyphicon-pencil"></i>详情</span>
                        </td>
                    </tr>
                </c:forEach>
                </tbody>
    ...
    <!--模态框，显示详细信息 不用的时候删除-->
    <div class="detailModal modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document" style="width:800px">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">科研日志</h4>
                </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $("#alter").click(function(){
                ...
                $.ajax({
                    url:"/student/science/detail/update",
                    data:data,
                    type:'post',
                    success:function(res){
                        var json = JSON.parse(res);
