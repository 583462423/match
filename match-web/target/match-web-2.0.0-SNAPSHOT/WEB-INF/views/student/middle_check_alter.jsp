...
<body>
<mydiv>
    <div style="width: 666px;height: 100%;">
        ...
        <c:if test="${isNull == 'true'}">
            ...
            <div class="input-group">
                ...
                <textarea name="comuWithTeacher" class="form-control"></textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">项目结果</div>
                <textarea name="projectResult" class="form-control" ></textarea>
            </div>

            <div class="input-group">
                <div class="input-group-addon">与期望结果的差异</div>
                <textarea name="isExpect" class="form-control" ></textarea>
            </div>

            <div class="input-group">
                <div class="input-group-addon">花费情况</div>
                <textarea name="costSituation" class="form-control" ></textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">学生观点</div>
                <textarea name="pointByStudent" class="form-control"></textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">教师观点</div>
                <textarea name="pointByTeacher" class="form-control"></textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">后续计划</div>
                <textarea name="followPlan" class="form-control"></textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">后续重点</div>
                <textarea name="followPoint"  class="form-control"></textarea>
            </div>
        ...
        <c:if test="${isNull != 'true'}">
            <!-- 上传过检查表-->
            <input name="matchItemId" class="form-control" type="hidden" value="${matchItemId}"></input>
            <div class="input-group">
                <div class="input-group-addon">与导师交流情况</div>
                <textarea name="comuWithTeacher">${middleCheck.comuWithTeacher}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">项目结果</div>
                <textarea name="projectResult" >${middleCheck.projectResult}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">与期望结果的差异</div>
                <textarea name="isExpect" >${middleCheck.isExpect}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">花费情况</div>
                <textarea name="costSituation"  >${middleCheck.costSituation}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">学生观点</div>
                <textarea name="pointByStudent" >${middleCheck.pointByStudent}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">教师观点</div>
                <textarea name="pointByTeacher" >${middleCheck.pointByTeacher}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">后续计划</div>
                <textarea name="followPlan" >${middleCheck.followPlan}</textarea>
            </div>
            <div class="input-group">
                <div class="input-group-addon">后续重点</div>
                <textarea name="followPoint" >${middleCheck.followPoint}</textarea>
            </div>
                ...
                $.ajax({
                    ...
                    success:function(res){
                        ...
                        if(json["success"] == "true"){
                            ...
                            setTimeout("location.href=\"/student/match/middle\"",2000);
                        }else{
                            showMsg(json["error"]);
                        }
                    }
