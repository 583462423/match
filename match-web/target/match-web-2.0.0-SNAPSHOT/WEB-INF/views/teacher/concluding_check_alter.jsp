...
<mydiv>
    <div style="width: 100%;height: 100%;">
        <form action="/teacher/match/concluding/report/update" method="post" id="updateForm">
            <!-- 上传过检查表-->
            ...
            <div class="input-group">
                ...
                <textarea style="height: 150px;" placeholder="请输入教师评价" name="viewOfTeacher" class="form-control">${concludingStatement.viewOfTeacher}</textarea>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#submitToNext").click(function(){
                ...
                $.ajax({
                    url:"/teacher/match/concluding/report/submit",
                    data:data,
                    type:'post',
                    success:function(res){
                        ...
                        if(json["success"] == "true"){
                            ...
                            setTimeout("location.href='/teacher/match/concluding'",2000);
                        }else{
                            showMsg(json["error"]);
                        }
                    }
            ...
            $("#passChange").click(function(){
                ...
                $.ajax({
                    url:'/teacher/match/concluding/change/submit',
                    data:data,
                    type:'post',
                    success:function(res){
                        var json = JSON.parse(res);
