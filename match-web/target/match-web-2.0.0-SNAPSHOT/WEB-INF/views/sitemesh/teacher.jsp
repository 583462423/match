            ...
            <div class="left_col scroll-view">
                ...
                <div class="profile clearfix">
                    ...
                    <div class="profile_info">
                        <span>欢迎您</span>
                        <h2>老师</h2> <!-- 后续可以将cookie中设置的用户的名字放到这来-->
                    </div>
                </div>
                <!-- /menu profile quick info -->
                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            <li><a href="/teacher/index" ><i class="fa fa-home"></i> 主页</a></li>
                            <li><a><i class="fa fa-home"></i> 比赛<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/check/teacher">待审核比赛</a></li>
                                    <li><a href="/check/teacher/done">已审核比赛</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-home"></i> 中期检查<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/teacher/match/middle">待审核比赛</a></li>
                                </ul>
                            </li>
                            <li><a><i class="fa fa-home"></i>结题报告<span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">
                                    <li><a href="/teacher/match/concluding">当前比赛</a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
