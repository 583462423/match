...
<mydiv>
    <div style="width: 100%;height: 100%;">
        <form action="/academy/match/middle/report/update" method="post" id="updateForm">
            <!-- 上传过检查表-->
            ...
            <div class="input-group">
                ...
                <textarea name="viewOfAcademy" placeholder="请填写学院评价">${middleCheck.viewOfAcademy}</textarea>
            </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $("#submitToNext").click(function(){
                ...
                $.ajax({
                    url:"/academy/match/middle/report/submit",
                    data:data,
                    type:'post',
                    success:function(res){
                        ...
                        if(json["success"] == "true"){
                            ...
                            setTimeout("location.href='/academy/match/middle';",2000);
                        }else{
                            showMsg(json["error"]);
                        }
                    }
            ...
            $("#passChange").click(function(res){
                ...
                $.ajax({
                    url:'/academy/match/middle/change/submit',
                    data:data,
                    type:'post',
                    success:function(res){
                        var json = JSON.parse(res);
